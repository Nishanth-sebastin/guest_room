...
import EcommerceCheckout from 'src/views/apps/Rooms/EcommerceCheckout';

const FullLayout = Loadable(lazy(() => import('../layouts/full/FullLayout')));
const BlankLayout = Loadable(lazy(() => import('../layouts/blank/BlankLayout')));
const Dashboard = Loadable(lazy(() => import('../views/dashboard/Dashboard')));
const RoomMain = Loadable(lazy(() => import('../views/apps/Rooms/Ecommerce')));
const EcommerceDetail = Loadable(lazy(() => import('../views/apps/Rooms/EcommerceDetail')));
