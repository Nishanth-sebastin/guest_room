    ...
    <ParentCard title="Create Room">
      <form>
        ...
        <CustomTextField
          ...
          variant="outlined"
          fullWidth
          value={formik.values.roomid+data.roomid}
        ...
        <CustomTextField
          ...
          variant="outlined"
          fullWidth
          value={formik.values.roomsize+data.roomsize}
          onChange={formik.handleChange}
        />
        ...
        <CustomTextField
          ...
          variant="outlined"
          fullWidth
          value={formik.values.roomname+data.roomname}
          onChange={formik.handleChange}
        />
        ...
        <CustomTextField
          ...
          variant="outlined"
          fullWidth
          value={formik.values.numberofbeds+data.numberofbeds}
          onChange={formik.handleChange}
        />
        ...
        <CustomTextField
          ...
          variant="outlined"
          fullWidth
          value={formik.values.amenities+data.amenities}
          onChange={formik.handleChange}
        />
        ...
        <CustomTextField
          ...
          variant="outlined"
          fullWidth
          value={formik.values.minimumbookingperiod+data.minimumbookingperiod}
          onChange={formik.handleChange}
        />
        ...
        <CustomTextField
          ...
          variant="outlined"
          fullWidth
          value={formik.values.maximumbookingperiod+data.maximumbookingperiod}
          onChange={formik.handleChange}
        />
        ...
        <CustomTextField
          ...
          variant="outlined"
          fullWidth
          value={formik.values.amountPerDay+data.amountPerDay}
          onChange={formik.handleChange}
        />
