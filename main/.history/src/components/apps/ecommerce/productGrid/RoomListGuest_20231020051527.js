...
const RoomListGuest = ({ onClick }) => {
  ...
  const handleRoute=(ownername,roomid)=>{
    localStorage.setItem('ownername',ownername)
    navigate(`/guest/${guestname}/room/detail/${ownername}/${roomid}`)
  }
  return (
    <Box>
              ...
              >
                <BlankCard className="hoverCard">
                  <Typography component={Typography} >
                    <CardMedia  onClick={()=>{handleRoute(room.ownername,room.roomid)}} component="img" width="100%" image={room.images[0]} alt="products" />
                  </Typography>
