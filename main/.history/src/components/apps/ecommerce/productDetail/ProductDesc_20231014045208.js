    ...
    <ChildCard>
      <Box>
        ...
        <TabPanel value={value} index={0}>
          {data.amenities && typeof data.amenities === 'string' ? (
        ...
        In this modified code, data.amenities && typeof data.amenities === 'string' checks if
        data.amenities is defined and is a string before proceeding with the split operation. If
        data.amenities is not a string or is undefined, it will display 'No Room Details'. This
        conditional check helps prevent the error you were encountering.
