    ...
    <ChildCard>
      <Box>
        ...
        <TabPanel value={value} index={0}>
          ...
          Experience unparalleled comfort at {data.roomname}, where each room offers a generous {data.roomsize} sq.ft. of space and {data.numberofbeds} cozy beds, ensuring a restful stay. Our flexible booking options range from a minimum of {data.miniumbookingperiod} days to a maximum of {data.maximumbookingperiod} days, all at a reasonable rate of ₹{data.rateperday} per day. Enjoy modern conveniences, including available wifi, efficient air conditioning, dedicated workspace, smoking allowance, and private bathrooms. {data.roomname} provides the perfect blend of comfort and affordability, promising a delightful stay in the heart of the city.
          </Typography>
