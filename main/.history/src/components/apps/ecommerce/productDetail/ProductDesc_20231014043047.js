    ...
    <ChildCard>
      <Box>
        ...
        <TabPanel value={value} index={0}>
          ...
          Discover comfort at {data.roomname}, featuring spacious rooms with {data.roomsize} sq.ft. area and 4 beds. Enjoy flexible stays for 2 to 5 days at just ₹500 per day. Amenities include wifi, air conditioning, workspace, smoking allowance, and private bathrooms. Your ideal Coimbatore retreat awaits!
          </Typography>
