    ...
    <ChildCard>
      <Box>
        ...
        <TabPanel value={value} index={0}>
          ...
          Enjoy modern conveniences, including available wifi, efficient air conditioning, dedicated workspace, smoking allowance, and private bathrooms. {data.roomname} provides the perfect blend of comfort and affordability, promising a delightful stay in the heart of the city.
          </Typography>
