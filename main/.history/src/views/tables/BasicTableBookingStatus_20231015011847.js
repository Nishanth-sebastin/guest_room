...
const navigate=useNavigate()
  ...
  const handleBook=(roomid,ownername,bookeddates)=>{
    ...
    sessionStorage.setItem("bookeddates",bookeddates)
            ...
            >
              ...
              <TableBody>
                {loading ? (
                  ...
                  <>
                    {data.map((dt) => (
                      <TableRow key={dt.id}  style={{ display: dt.status === 'Rejected' ? 'none' : 'table-row' }}>
                        <TableCell>
                        ...
                        <TableCell>
                          {dt.status == 'Request Sent' ? (
                            ...
                            <Link  >
                              ...
                              <Button  onClick={()=>handleBook(dt.roomid,dt.ownername,dt.bookingdates)} variant="contained">Book Now</Button>
                            </Link>
                          )}
                        </TableCell>
                      </TableRow>
